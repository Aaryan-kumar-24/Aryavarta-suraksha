...
def run():
    """
    Draw no-entry / touch-alert boxes and save to service/box2
    Left click:
    ...
    def mouseClick(event, x, y, flags, params):
        ...
        if event == cv2.EVENT_LBUTTONDOWN:
            ...
            # 🔴 delete if clicked inside existing box
    ...
    cv2.namedWindow("No-Entry Box Selector")
    cv2.setMouseCallback("No-Entry Box Selector", mouseClick)
    ...
    while True:
        ...
        cv2.imshow("No-Entry Box Selector", img)
